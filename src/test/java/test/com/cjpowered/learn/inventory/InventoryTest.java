...
public class InventoryTest {
    ...
    @Test
    public void orderEnoughSeasonalStockWhenPackageContainsMultipleUnitsAndNotInSeason(){
    	// given
    	final int onHand = 10;
    	final int shouldHave = 16;
    	final int unitsPerPackage = 4;
    ...
    @Test
    public void orderEnoughStockWithSeasonalStockOnSaleAndAlreadyOnOrder(){
    	// given
    	final int onHand = 10;
    	final int shouldHave = 16;
    	final int unitsPerPackage = 1;
    	...
    	// then
    	Order expectedOrder = new Order(item, shouldHave + 20 - onHand - onOrder);
    	Set<Order> expected = Collections.singleton(expectedOrder);
    	assertEquals(expected, new HashSet<>(actual));
    }
